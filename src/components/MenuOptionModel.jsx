...
const MenuOptionModel = ({ setMenuModel, variantData }) => {
    ...
    return (
        <div className="model-main fixed inset-0 bg-black/50 flex justify-center items-center z-10">
            <div className="modelcard bg-white p-8 flex flex-col justify-between min-w-[40%]">
                <div className="heading bg-red-300 flex justify-start items-center gap-2 py-5" >
                ...
                <div className="variation bg-blue-400  flex flex-col ">

                    {
                        ...
                        variantData?.variantsV2?.variantGroups?.map((re) => {
                            return (
                                ...
                                <div key={re.groupId} className="bg-yellow-100">
                                    <div className="font-semibold text-2xl py-2">⁎ {re?.name}</div>
                                    {
                                        ((re?.variations)?.map((data) => {
                                            return (
                                                <div key={data?.id}>
                                                    <div className="flex bg-red-200 items-center">
                                                        ...
                                                        <div className="optionData flex bg-pink-300 py-3 gap-4">
...

                    {
                        ...
                        variantData?.variants?.variantGroups?.map((ree) => {
                            return (<>

                                <div key={ree.groupId}>{ree?.name}</div>
