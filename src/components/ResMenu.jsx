                    ...
                    <div className="summaryData flex flex-col justify-between w-full bg-yellow-300 p-4 pt-6" >
                        {
                            showAccordians?.map((it, index) => (
                                (it?.card?.card?.title) &&
                                <div key={index} className="div bg-green-400 m-5 p-6">
                                    {
                                        <>
                                            <div className=" flex flex-col gap-10 bg-red-500">

                                                <span className="summary text-xl font-open font-bold " onClick={() => setShowRecommended(!showRecommended)}> {it?.card?.card?.title} </span>
