...
const Navbar = () => {
    ...
    const getLocation = async () => {
        ...
        // const API_KEY = `AIzaSyC3pY-L0ZqvvXR5MFg8BCCdnivkwagPYfo`;
        // const END_POINT = `https://www.googleapis.com/geolocation/v1/geolocate?key=AIzaSyC3pY-L0ZqvvXR5MFg8BCCdnivkwagPYfo`;
        const END_POINT = `https://ipapi.co/json`;



        // const test = `https://api.openweathermap.org/data/2.5/weather?q=varanasi&appid=${API_key}`;
    ...
    return (
        <div className="navbar flex flex-row justify-around items-center border-4 border-red-600" >
            ...
            <div className="nav-items flex flex-row justify-center items-center">
                <ul className="items flex flex-row justify-center items-center gap-16 p-4 m-2 px-10">
